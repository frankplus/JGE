...
enum CtrlButtons
{
	CTRL_SELECT     = 0x00000001,
	CTRL_START      = 0x00000002,
	CTRL_UP         = 0x00000004,
	CTRL_RIGHT      = 0x00000008,
	CTRL_DOWN      	= 0x00000010,
	CTRL_LEFT      	= 0x00000020,
	CTRL_LTRIGGER   = 0x00000040,
	CTRL_RTRIGGER   = 0x00000080,
	CTRL_TRIANGLE   = 0x00000100,
	CTRL_CIRCLE     = 0x00000200,
	CTRL_CROSS      = 0x00000400,
	CTRL_SQUARE     = 0x00000800,
	CTRL_NOTE       = 0x00001000
};
